...
public class SteamCraftWorldGenerator implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int x, int z) {
		this.addOreSpawn(SteamCraftBlock.engineeringQuartzOre, world, random, x, z, 16,
				16, 4 + random.nextInt(3), 7, 15, 50);
		this.addOreSpawn(SteamCraftBlock.copperOre, world, random, x, z, 16,
				16, 4 + random.nextInt(3), 7, 15, 50);
		this.addOreSpawn(SteamCraftBlock.zincOre, world, random, x, z, 16,
				16, 4 + random.nextInt(3), 7, 15, 50);
		this.addOreSpawn(SteamCraftBlock.ioliteOre, world, random, x, z, 16,
				16, 4 + random.nextInt(3), 7, 15, 50);
	}
